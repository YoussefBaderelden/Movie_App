class ModelBrowser {
  ...
  ModelBrowser({this.status, this.statusMessage, this.data, this.meta});

  ModelBrowser.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Movies {
  ...
  Movies.fromJson(Map<String, dynamic> json) {
    ...
    slug = json['slug'];
    year = json['year'];
    rating = json['rating'] is int ? (json['rating'] as int).toDouble() : json['rating']; // Handle int to double conversion
